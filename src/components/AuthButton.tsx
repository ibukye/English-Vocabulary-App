...
import { getAuth, signInWithRedirect, signInWithPopup, GoogleAuthProvider, signOut, getRedirectResult, AuthError } from 'firebase/auth';
...
export default function AuthButton() {
  ...
  const handleLogout = async () => {
    try {
      ...
      console.error("ログアウトエラー:", authError);
      alert(`ログアウトエラー: ${authError.message}`);
    }
  };
